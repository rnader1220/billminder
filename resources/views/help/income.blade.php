...
<ul>
    <li>[ <i class='fa-solid fa-fw fa-rotate'></i>&nbsp;&nbsp;Cycle ]: This will 'cycle' the income, create a register record, and advance the date according to the frequency setting.</li>
</ul>
