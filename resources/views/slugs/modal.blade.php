    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-[80%] p-6 relative">
        <div class="container mx-auto px-4">
            ...
            <div class="flex justify-end mb-4" id="btn-group-head">
                <button type="button" id="control_edit" class="btn btn-warning mr-2" disabled><i
                        class='fa-solid fa-edit mr-1'></i>Change</button>

                <button type="button" id="control_delete" class="btn btn-danger mr-2" disabled><i
                        class='fa-solid fa-trash mr-1'></i>Delete</button>
            </div>

        </div>

        <div id="modal_content" x-data="{ showHelp: false }">
        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-end mb-4" id="btn-group-foot">
                ...
                <button type="button" id="control_save" class="btn btn-success mr-2" disabled><i
                        class='fa-solid fa-floppy-disk-pen mr-1'></i>Save</button>

                <button type="button" id="control_cancel" class="btn btn-secondary mr-2" disabled><i
                        class='fa-solid fa-backward mr-1'></i>&nbsp;Cancel</button>

                <button type="button" id="control_close" class="btn btn-secondary mr-2" disabled><i
